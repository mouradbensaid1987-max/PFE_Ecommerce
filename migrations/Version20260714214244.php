 ...
 */
final class Version20260714214244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_item (id INT AUTO_INCREMENT NOT NULL, product_name VARCHAR(200) NOT NULL, price_ttc NUMERIC(10, 2) NOT NULL, quantity INT NOT NULL, order_ref_id INT NOT NULL, INDEX IDX_52EA1F09E238517C (order_ref_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
